...
class Pencairan extends Authenticated
{
	...
	public function index()
	{
		...
		$this->load->view('report/pencairan/index',$data);
	}
	
	public function weekly()
	{
        $data['areas'] = $this->areas->all();
		$this->load->view('report/pencairan/weekly',$data);
	}
	
	public function monthly()
	{
        $data['areas'] = $this->areas->all();
		$this->load->view('report/pencairan/monthly',$data);
	}
	...
	{		
		...
		$filename ="Pencairan_".$month."_".$year;
