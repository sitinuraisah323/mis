...
<base href=".<?php echo base_url(); ?>.<?php echo base_url(); ?>.<?php echo base_url(); ?>.<?php echo base_url(); ?>"><!--end::Base Path -->
        ...
        <link rel="stylesheet" href="https://fonts.googleapis.com/css?family=Poppins:300,400,500,600,700">        <!--end::Fonts -->
                    ...
                    <!--begin::Page Custom Styles(used by this page) -->
                             <link href="<?php echo base_url(); ?>assets/css/demo2/pages/error/error-6.css" rel="stylesheet" type="text/css" />
...
<!-- end::Page Loader -->        
	...
	<div class="kt-error_container">
		...
		<p class="kt-error_description kt-font-light">
			Cannot access this page, setting role for access the page.<br>
			We're working on it			 
		</p>		 
	</div>	 
</div>
