...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            ...
            <span class="kt-subheader__desc">Pencairan Nasional</span>
        </div>
...
<!-- end:: Content Head -->
 ...
 <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <form id="form_bukukas" class="form-horizontal" method="post" action="<?php echo base_url("report/pencairan/export_monthly"); ?>">
            ...
            <div class="col-md-12" >
                <div class="form-group row">
                    ...
                    <div class="col-lg-2">
                        ...
                        <button type="button" class="btn btn-brand btn-icon" name="btncari_monthly" id="btncari_monthly"><i class="fa fa-search"></i></button>
                        <button type="submit" class="btn btn-danger btn-icon" name="btnexport_monthly" id="btnexport_monthly"><i class="fa fa-file-excel"></i></button>
                        </div>
                    </div>                  
				</div>
						...
						<table class="table">
						  	<thead class="thead-light">
						    	<tr>
									...
									<th class='text-right'>Pencairan Regular</th>
									<th class='text-right'>Pencairan Cicilan</th>
...
$this->load->view('report/pencairan/_script.php');
?>
