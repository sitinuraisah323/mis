...
<!-- end::Page Loader -->
	...
	<div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor" style="background-image: url(<?php echo base_url(); ?>assets/media/bg/bg-9.jpg);">
			...
			<div class="kt-login__container">
				...
				<div class="kt-login__signin">
					<div class="kt-login__head">
						<h3 class="kt-login__title">Sign In To GHAmis</h3>
					</div>
