...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">            
            ...
            <span class="kt-subheader__desc">Pelunasan Gadai Reguler</span>            
        </div>
...
$this->load->view('transactions/repayment/_upload.php');
$this->load->view('transactions/repayment/_script.php');
?>