...
function initCariForm(){
    ...
    $('#type').select2({ placeholder: "Pilih Produk", width: '100%' });
    //events
    $('#btncari').on('click',function(){
		...
		$.ajax({
            ...
            dateEnd:dateEnd,permit:permit, sort_by, sort_method, type},
				...
				if(response.status == true){
					...
					$.each(response.data, function (index, data) {
                        ...
                        if(statusrpt=="1"){
                            ...
                            if(data.date_repayment){ var DateRepayment = moment(data.date_repayment).format('DD-MM-YYYY');}else{ var DateRepayment = "-";}
                            // if(status=="Aktif"){
                            //     DateRepayment="-";
                            // }
