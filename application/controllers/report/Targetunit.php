...
class Targetunit extends Authenticated
 {
    ...
    */
    ...
    public function export()
    {
        ...
        //         $this->u_target->db->select('a.id,b.id as id_unit,b.name,b.id_area,c.area,a.month,a.year,a.amount_booking,a.amount_outstanding,a.status,a.date_create,a.date_update,a.user_create,a.user_update');		
		// $this->u_target->db->join('units as b','b.id=a.id_unit');		
		// $this->u_target->db->join('areas as c','c.id=b.id_area');	
        // $this->u_target->db->where('')	
		// $this->u_target->db->order_by('a.id','desc');		
