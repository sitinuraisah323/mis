            ...
            <div class='kt-container '>
                <div class='kt-subheader__main'>
                    <h3 class='kt-subheader__title'><a
                            href="<?php echo base_url('datamaster/customers');?>">Datamaster</a></h3>
...
<i class = 'flaticon2-plus'></i> Upload
                ...
                <div class='kt-portlet__body kt-portlet__body--fit'>
                    <div class='col-md-pull-12'>
                        ...
                        <!--end: Alerts -->
                        <!--begin: Search Form -->
                        <form action="<?php echo base_url('datamaster/customers/excel');?>"
...
?>
    ...
    ?>
                                ...
                                <div class='col-lg-2'>
                                    <input type='submit' class='btn btn-danger btn-icon' value='excel'
                                        name='btnexport_csv'>
                                </div>
                                <?php endif;
    ?>
