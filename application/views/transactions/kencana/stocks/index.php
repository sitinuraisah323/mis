            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">  
                            <button type="button" class="btn btn-brand btn-icon-sm" onclick="modalShow()" >
...
$this->load->view('transactions/kencana/stocks/_add.php');
$this->load->view('transactions/kencana/stocks/_script.php');
?>
