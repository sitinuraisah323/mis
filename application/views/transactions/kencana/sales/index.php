            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">  
                            <a type="button" class="btn btn-brand btn-icon-sm" href="<?php echo base_url('transactions/kencana/sales/form');?>" >
...
$this->load->view('transactions/kencana/sales/_script.php');
?>
