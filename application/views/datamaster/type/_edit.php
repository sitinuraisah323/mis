                        ...
                        <div class="row"> 
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Jenis</label>
                                    <select class="form-control select2" name="jenis" id="e_jenis">
                                    <option value=""></option>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label>Code</label>
                                    <input type="text" class="form-control" id="e_code" name="code">
                                </div>  
                            </div>  
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <label>Type</label>
                                    <input type="text" class="form-control" id="e_type" name="type">	                            		
                                </div>
                            </div>
