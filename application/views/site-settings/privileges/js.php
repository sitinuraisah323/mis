...
function initDTEvents(){
    $(".btn_delete").on("click",function(){
        ...
        swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type : 'GET',
                    url : "<?php echo base_url("api/site-settings/levels/delete/"); ?>"+targetId,
                    dataType : "json",
    ...
    $(".btn_edit").on("click",function(){
        ...
        $.ajax({
            type : 'GET',
            url : "<?php echo base_url("api/site-settings/levels/show/"); ?>"+targetId,
            dataType : "json",
            success : function(response,status){
                ...
                if(response.status == true){
					...
					$('#modal_add').find('[name="level"]').val(response.data.level);
...
function initDataTable(){
    var option = {
        data: {
            ...
            source: {
              read: {
                url: '<?php echo base_url("api/site-settings/levels"); ?>',
                map: function(raw) {
                  // sample data mapping
                  var dataSet = raw;
          ...
          columns: [
            ...
            },
            {
                ...
                template: function (row) {
                    var result ="";
                        result = result + '<a href="<?php echo base_url('site-settings/privileges/settings/');?>'+row.id+'" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit" >Atur</a>';
                    return result;
                }
            }
          ],
...
function initAlert(){
    ...
    $("#input-form").on("submit",function(e){
    	...
    	var url;
    	if(id){
    		url = "<?php echo base_url("api/site-settings/levels/update"); ?>";
		}else{
    		url = "<?php echo base_url("api/site-settings/levels/insert"); ?>";
		}
        $.ajax({
            type : 'POST',
            url : url,
