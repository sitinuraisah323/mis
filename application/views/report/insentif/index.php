...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">            
            ...
            <span class="kt-subheader__desc">Insentif</span>            
        </div>
            ...
            <div class="col-md-12" > 
                ...
                <div class="form-group row">
                    <div class="col-lg-2">
						...
						<select class="form-control" name="month">
                            ...
                            <?php foreach($months as $key => $value):?>
                                <option value="<?php echo zero_fill($key,2);?>" <?php echo $key == date('n') ? 'selected' : ''?>><?php echo $value;?></option>
                            <?php endforeach;?>
						</select>
                    </div>
                    <div class="col-lg-2">
                    ...
                    <div class="col-lg-4">
                        ...
                        <button class="btn btn-danger btn-icon" type="button" onclick="getRegExcel()">
                            Reg
                        </button>
                        <button class="btn btn-danger btn-icon" type="button" onclick="getCicilExcel()">
                            Ccilan
                        </button>
                        <button class="btn btn-danger btn-icon" type="button" onclick="getExcel()">
                            excel
                        </button>
                        </div>
                    </div>
...
$this->load->view('report/insentif/_script.php');
?>
