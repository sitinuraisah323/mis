...
<span class = 'kt-subheader__desc'>One Obligor</span>
</div>
...
<form id = 'form_bukukas' class = 'form-horizontal' method = 'post' action = '<?php echo base_url('report/oneobligor/export_report'); ?>'>
...
<div class = 'col-lg-2'>
<label class = 'col-form-label'>No CIF</label>
...
<select class = 'form-control select2' name = 'ktp' id = 'ktp'>
<option value = ''></option>
<option value = 'all'>All</option>
</select>
</div>
...
<option value = 'no_cif'>No CIF</option>
...
<th class = 'text-right'>Jumlah UP</th>
<th></th>
</tr>
</thead>
<tbody>
...
<input type = 'hidden' name = 'url_get_ktp' id = 'url_get_ktp' value = "<?php echo base_url('api/datamaster/units/get_customers_bycif') ?>"/>
...
$this->load->view('report/oneobligor/detail_oneobligor.php');
$this->load->view( 'report/oneobligor/js.php' );
// $this->load->view('report/oneobligor/detail_oneobligor.php');
