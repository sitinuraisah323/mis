...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            ...
            <span class="kt-subheader__desc">Gadai Smartphone</span>
        </div>
...
<!-- end:: Content Head -->
 ...
 <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <form id="form_bukukas" class="form-horizontal" method="post" action="<?php echo base_url("report/regularpawns/export_smartphone"); ?>">
                   ...
                   <div class="col-lg-2">
                    ...
                    <!-- <div class="col-lg-2">
                        ...
                        <select class="form-control select2" name="merk" id="merk">
                            ...
                            <option value="relmea">Realme</option>
                    ...
                    <div class="col-lg-2">
                        ...
                        <button type="submit" class="btn btn-success btn-icon" name="btnexport_csv" id="btnexport_csv"><i class="fa fa-file-excel"></i></button>
...
$this->load->view('report/smartphone/js.php');
?>
