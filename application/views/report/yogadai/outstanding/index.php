...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            ...
            <span class="kt-subheader__desc">Outstanding Yo-Gadai</span>
        </div>
            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                       Data Outstanding Nasional(Yo-Gadai)
                    </h3>
                </div>
						...
						<table class="table">
						  	<thead class="thead-light">
						    	<tr>
									...
									<th class="text-left">Pencairan</th>
									<th class="text-left">Pelunasan</th>
									<!-- <th class='text-center'>Noa</th> -->
									<th class='text-right'>Outstanding</div></th>
									<th></th>
						    	</tr>
						  	</thead>
						  	<tbody>
