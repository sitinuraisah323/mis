<h3>Yuk Gadai Outstanding Nasional <?php echo date('d-m-Y');  ?></h3>
<?php  
...
<hr/>
         ...
         <table class="table" border="1">
            <tr bgcolor="#cccccc">
                <td colspan="6" align="center">Yuk Gadai</td>
            </tr>
            <tr bgcolor="#cccccc">
            ...
            <?php
                $yesterdayos += $data->ost_yesterday->up;
                $yesterdaynoa += $data->ost_yesterday->noa;
                $creditTodayOs +=  $data->credit_today->up_reguler;
                $creditTodayNoa += $data->credit_today->noa_reguler;
                $repaymentTodayNoa += $data->repayment_today->noa_reguler;
                $repaymentTodayUp += $data->repayment_today->up_reguler;
