...
<!-- end:: Content Head -->
 ...
 <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <form id="form_bukukas" class="form-horizontal" method="post" action="<?php echo base_url("report/opsi/export"); ?>">
            ...
            <div class="col-md-12" >
                ...
                <?php endif ;?>
                    ...
                    <input type="hidden" name="type" value="OPSI" />
                    <div class="col-lg-2">
						...
						<table class="table">
						  	<thead class="thead-light">
						    	<tr>
									...
									<th class="text-center">Masa Gadai</th>
...
$this->load->view('report/opsi/_script.php');
?>
