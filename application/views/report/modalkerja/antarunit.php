...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">            
            ...
            <span class="kt-subheader__desc">Modal Kerja Antar Unit</span>            
        </div>
        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <div class="col-md-12" > 
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-1">
                        <button type="button" class="btn btn-brand btn-icon" name="btncariMutasiUnit" id="btncariMutasiUnit"><i class="fa fa-search"></i></button>
                    </div>
				</div>	               
            ...
            <div class="col-md-12">
                <div class="kt-section__content">
						<table class="table" id="tblmodalkerjamutasiunit">
...
$this->load->view('report/modalkerja/_script.php');
?>