    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Transaksi Via</h5>
                    ...
                    <div class="form-body">
                        ...
                        <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="id_payments" id="edit_area_name">
                                    <?php 
                                        if (!empty($payments)){
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label>Via</label>
                                    <input type="text" class="form-control" id="edit_area_via" name="via">	                            		
                                </div>
                            </div>  
