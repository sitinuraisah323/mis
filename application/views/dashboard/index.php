        ...
        <div class="kt-subheader   kt-grid__item" id="kt_subheader">
            <div class="kt-container ">
                <div class="kt-subheader__main">
                    ...
                    <span class="kt-subheader__desc">GHA Sales LM <input type="hidden" name="permit" id="permit"
                            value="<?php echo $permit; ?>" /></span>
                </div>
                <div class="kt-subheader__toolbar">
                    <div class="kt-subheader__wrapper">
                        ...
                        <div href="" class="btn kt-subheader__btn-daterange" id="kt_dashboard_daterangepicker"
                            data-toggle="kt-tooltip" title="Dashboard Overview" data-placement="left">
                            <span class="kt-subheader__btn-daterange-title" id="kt_dashboard_daterangepicker_title">To
                                Day Transaction :</span>&nbsp;
                            <span class="kt-subheader__btn-daterange-date"
                                id="kt_dashboard_daterangepicker_date"><?php echo date("l \of F d, Y");?></span>
                            <i class="flaticon2-calendar-1"></i>
                        </div>
                        <?php }else{ $currmonth = date('F', strtotime('-1 days', strtotime($currmonth)));?>
                        <div href="" class="btn kt-subheader__btn-daterange" id="kt_dashboard_daterangepicker"
                            data-toggle="kt-tooltip" title="Dashboard Overview" data-placement="left">
                            <span class="kt-subheader__btn-daterange-title" id="kt_dashboard_daterangepicker_title">Last
                                Day Transaction : </span>&nbsp;
                            <span class="kt-subheader__btn-daterange-date"
                                id="kt_dashboard_daterangepicker_date"><?php echo date('l \of F d, Y', strtotime('-1 days', strtotime(date('Y-m-d')))); ?></span>
                            <i class="flaticon2-calendar-1"></i>
                        </div>
                        <?php }?>
                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <h3 class="kt-widget14__title">
                                                <i class="fa fa-chart-bar"></i>  Daily 
                                                <i class="fa fa-eye pull-right" onclick="outstanding(event)"></i>
                                            </h3>
                                            <div class="kt-widget14__legends">
                                                <div class="kt-widget14__legend">
                                                    <span class="kt-widget14__bullet kt-bg-info"></span>
                                                    <span class="kt-widget14__stats"><span class="date-today"></span> :
                                                        <span class="total-today"></span></span>
                                                    <span class="kt-widget14__bullet kt-bg-warning"></span>
                                                    <span class="kt-widget14__stats"><span
                                                            class="date-yesterday"></span> : <span
                                                            class="total-yesterday"></span></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion accordion-light accordion-toggle-plus" id="accordionExample3cc">
                                    <div class="card">
                                        <div class="card-header" id="headingOne3cc">
                                            <div class="card-title collapsed" data-toggle="collapse"
                                                data-target="#collapseOne3cc" aria-expanded="true"
                                                aria-controls="collapseOne3cc">
                                                View Detail
                                            </div>
                                        </div>
                                        <div id="collapseOne3cc" class="collapse" aria-labelledby="headingOne3cc"
                                            data-parent="#accordionExample3cc">
                                            <div class="card-body">
                                ...
                                <div class="accordion accordion-light accordion-toggle-plus" id="accordionExample3">
                                    <div class="card">
                                        <div class="card-header" id="headingOne3Disburse">
                                            <div class="card-title collapsed" data-toggle="collapse"
                                                data-target="#collapseOne3Disburse" aria-expanded="true"
                                                aria-controls="collapseOne3Disburse">
                                                View Detail
                                            </div>
                                        </div>
                                        <div id="collapseOne3Disburse" class="collapse"
                                            aria-labelledby="headingOne3Disburse" data-parent="#accordionExample3">
                                            <div class="card-body">
                                ...
                                <div class="accordion accordion-light accordion-toggle-plus" id="accordionExample3">
                                    <div class="card">
                                        <div class="card-header" id="headingPelunasan">
                                            <div class="card-title collapsed" data-toggle="collapse"
                                                data-target="#collapsePelunasan" aria-expanded="true"
                                                aria-controls="collapsePelunasan">
                                                View Detail
                                            </div>
                                        </div>
                                        <div id="collapsePelunasan" class="collapse" aria-labelledby="headingPelunasan"
                                            data-parent="#accordionExample3">
                                            <div class="card-body">
                                ...
                                <div class="accordion accordion-light accordion-toggle-plus" id="accordionExample3">
                                    <div class="card">
                                        <div class="card-header" id="headingDPD">
                                            <div class="card-title collapsed" data-toggle="collapse"
                                                data-target="#collapseDPD" aria-expanded="true"
                                                aria-controls="collapseDPD">
                                                View Detail
                                            </div>
                                        </div>
                                        <div id="collapseDPD" class="collapse" aria-labelledby="headingDPD"
                                            data-parent="#accordionExample3">
                                            <div class="card-body">
                                ...
                                <div class="accordion accordion-light accordion-toggle-plus" id="accordionExample3">
                                    <div class="card">
                                        <div class="card-header" id="headingSaldo">
                                            <div class="card-title collapsed" data-toggle="collapse"
                                                data-target="#collapseSaldo" aria-expanded="true"
                                                aria-controls="collapseSaldo">
                                                View Detail
                                            </div>
                                        </div>
                                        <div id="collapseSaldo" class="collapse" aria-labelledby="headingSaldo"
                                            data-parent="#accordionExample3">
                                            <div class="card-body">
                                ...
                                <div class="accordion accordion-light accordion-toggle-plus" id="accordionExample3">
                                    <div class="card">
                                        <div class="card-header" id="headingPengeluaran">
                                            <div class="card-title collapsed" data-toggle="collapse"
                                                data-target="#collapsePengeluaran" aria-expanded="true"
                                                aria-controls="collapsePengeluaran">
                                                View Detail
                                            </div>
                                        </div>
                                        <div id="collapsePengeluaran" class="collapse"
                                            aria-labelledby="headingPengeluaran" data-parent="#accordionExample3">
                                            <div class="card-body">
                                ...
                                <div class="accordion accordion-light accordion-toggle-plus" id="accordionExample3">
                                    <div class="card">
                                        <div class="card-header" id="headingPendapatan">
                                            <div class="card-title collapsed" data-toggle="collapse"
                                                data-target="#collapsePendapatan" aria-expanded="true"
                                                aria-controls="collapsePendapatan">
                                                View Detail
                                            </div>
                                        </div>
                                        <div id="collapsePendapatan" class="collapse"
                                            aria-labelledby="headingPendapatan" data-parent="#accordionExample3">
                                            <div class="card-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class="kt-widget14__header kt-margin-b-30">
                                            ...
                                            <div class="kt-widget14__legends">
                                                <div class="kt-widget14__legend">
                                                    <span class="kt-widget14__bullet kt-bg-success"></span>
                                                    <span class="kt-widget14__stats"><?php  echo "Purchase(on IDR) "; ?>
                                                        : <span class="total-target"></span></span>
                                                    <span class="kt-widget14__bullet kt-bg-info"></span>
                                                    <span class="kt-widget14__stats"><?php  echo "Sale(on IDR) "; ?> :
                                                        <span class="total-realisasi"></span></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="accordion accordion-light accordion-toggle-plus" id="accordionExample3">
                                    <div class="card">
                                        <div class="card-header" id="headingLM">
                                            <div class="card-title collapsed" data-toggle="collapse"
                                                data-target="#collapseLM" aria-expanded="true"
                                                aria-controls="collapseLM">
                                                View Detail
                                            </div>
                                        </div>
                                        <div id="collapseLM" class="collapse" aria-labelledby="headingLM"
                                            data-parent="#accordionExample3">
                                            <div class="card-body">
                                        ...
                                        <div class="kt-widget14__header kt-margin-b-30">
                                            ...
                                            <div class="kt-widget14__legends">
                                                <div class="kt-widget14__legend">
                                                    <span class="kt-widget14__bullet kt-bg-success"></span>
                                                    <span
                                                        class="kt-widget14__stats"><?php  echo "Target on ".$currmonth; ?>
                                                        : <span class="total-target"></span></span>
                                                    <span class="kt-widget14__bullet kt-bg-info"></span>
                                                    <span
                                                        class="kt-widget14__stats"><?php  echo "Realisasi on ".$currmonth; ?>
                                                        : <span class="total-realisasi"></span></span>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div class="accordion accordion-light accordion-toggle-plus" id="accordionExample3">
                                    <div class="card">
                                        <div class="card-header" id="headingtarBooking">
                                            <div class="card-title collapsed" data-toggle="collapse"
                                                data-target="#collapsetarBooking" aria-expanded="true"
                                                aria-controls="collapsetarBooking">
                                                View Detail
                                            </div>
                                        </div>
                                        <div id="collapsetarBooking" class="collapse"
                                            aria-labelledby="headingtarBooking" data-parent="#accordionExample3">
                                            <div class="card-body">
                                ...
                                <div class="accordion accordion-light accordion-toggle-plus" id="accordionExample3">
                                    <div class="card">
                                        <div class="card-header" id="headingtarOut">
                                            <div class="card-title collapsed" data-toggle="collapse"
                                                data-target="#collapsetarOut" aria-expanded="true"
                                                aria-controls="collapsetarOut">
                                                View Detail
                                            </div>
                                        </div>
                                        <div id="collapsetarOut" class="collapse" aria-labelledby="headingtarOut"
                                            data-parent="#accordionExample3">
                                            <div class="card-body">
