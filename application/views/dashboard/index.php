		...
		<div class="kt-container ">
			...
			<div class="kt-subheader__toolbar">
				...
				<div href="" class="btn kt-subheader__btn-daterange" id="kt_dashboard_daterangepicker" data-toggle="kt-tooltip" title="Dashboard Overview" data-placement="left">
                        ...
                        <span class="kt-subheader__btn-daterange-date" id="kt_dashboard_daterangepicker_date"><?php echo date('M'); ?> <?php echo date('d', strtotime(date('Y-m-d')));// date('d', strtotime('-1 days', strtotime(date('Y-m-d')))); ?></span>
