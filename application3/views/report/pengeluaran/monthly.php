...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">            
            ...
            <span class="kt-subheader__desc">Pengeluaran Bulanan</span>            
        </div>
...
<!-- end:: Content Head -->
 ...
 <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <form id="form_bukukas" class="form-horizontal" method="post" action="<?php echo base_url("report/pengeluaran/export_monthly"); ?>">
...
$this->load->view('report/pengeluaran/_script.php');
?>
