...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            ...
            <span class="kt-subheader__desc">Konversi Outstanding</span>
        </div>
...
<!-- end:: Content Head -->
 ...
 <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <form id="form_bukukas" class="form-horizontal" method="post" action="<?php echo base_url("report/konversi/export_os"); ?>">
						...
						<table class="table">
						  	<thead class="thead-light">
						    	<tr>
									...
									<th class="text-right">OS Real</th>
									<th class='text-right'>OS GHANet</th>
									<th class='text-right'>OS BAP x GHANet</th>									
									<th class='text-right'>OS Real x GHANet</th>									
									<th class='text-right'>OS BAP x OS Real</th>									
						    	</tr>
						  	</thead>						  	                         
						</table>
				</div>
...
$this->load->view('report/konversi/_outstanding.php');
?>
