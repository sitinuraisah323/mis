...
<!-- end:: Content Head -->
 ...
 <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <form id="form_bukukas" class="form-horizontal" method="post" action="<?php echo base_url("report/pagukas/export"); ?>">
            ...
            <div class="col-md-12" >
                <div class="form-group row">
                    ...
                    <div class="col-lg-2">
                        ...
                        <!-- <a href="<?php echo base_url('report/pagukas/reportpdf?date='.$this->input->post('date-start')); ?>" class="btn btn-success btn-icon" ><i class="fa fa-file-pdf"></i></a> -->
                        </div>
                    </div>                  
				</div>
						...
						<table class="table">
						  	<thead class="thead-light">
						    	<tr>
									...
									<th class='text-right'>Pagu Moker</th>
...
$this->load->view('report/pagu/_script.php');
?>
