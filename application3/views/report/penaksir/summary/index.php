...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">
            ...
            <span class="kt-subheader__desc">Barang Jaminan Reguler</span>
        </div>
...
<!-- end:: Content Head -->
 ...
 <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
                <div class="kt-portlet__head-label">
                    ...
                    <h3 class="kt-portlet__head-title">
                       Summary Barang Jaminan Reguler
                    </h3>
                </div>
        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <form id="form_bukukas" class="form-horizontal" method="post" action="<?php echo base_url("report/penaksir/export"); ?>">
						...
						<table class="table" id="tblpenaksir">
						  	<thead class="thead-light">
						    	<tr>
									...
									<!-- <th class='text-right'>Group By</th> -->
									<th class='text-right'>Taksiran</th>									
									<th class='text-right'>UP</th>									
									<th class='text-right'>Gramasi</th>									
...
$this->load->view('report/penaksir/summary/_script.php');
?>
