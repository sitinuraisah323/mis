					...
					<div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile "  >
						<ul class="kt-menu__nav ">
							...
							<?php if($level=='administrator'){ ?>
								<a  href="<?php echo base_url('dailyreport/unitsreport'); ?>" class="btn btn-secondary"><i class="fa fa-envelope"></i> Upload</a>&nbsp
								<!-- <a  href="<?php //echo base_url('dailyreport/unitsreportojk'); ?>" class="btn btn-success"><i class="fa fa-check-double"></i> OJK</a>&nbsp -->
							<?php } ?>
								<?php if($level=='kasir'){ ?>
								<a  href="<?php echo base_url();?>/assets/guide/manualguidebj.pdf" class="btn btn-primary" title="Manual Guide Barang Jaminan" target="_blank"><i class="fa fa-file"></i> Manual Guide</a>&nbsp
								<?php }else{ ?>
                					<a  href="#" data-toggle="modal" data-target="#ticket" class="btn btn-secondary" title="Ticket Complain"><i class="fa fa-comments"></i></a>&nbsp
								<?php } ?>
								<a  href="#"  data-toggle="modal" data-target="#help" class="btn btn-secondary"><i class="fa fa-exclamation-circle"></i> Help</a>
							</li>
						</ul>
					</div>
				</div>
