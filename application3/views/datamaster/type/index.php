...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">            
            <h3 class="kt-subheader__title">Data Type Product</h3>            
            <span class="kt-subheader__separator kt-subheader__separator--v"></span>            
            <span class="kt-subheader__desc">Type</span>            
        </div>
...
$this->load->view('datamaster/type/_add.php');
$this->load->view('datamaster/type/_edit.php');
$this->load->view('datamaster/type/_script.php');
?>