...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">            
            ...
            <span class="kt-subheader__desc">Kategori Transaksi</span>            
        </div>
...
$this->load->view('datamaster/mapingcategory/_edit.php');
$this->load->view('datamaster/mapingcategory/_script.php');
?>