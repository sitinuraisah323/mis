...
<div class="kt-subheader   kt-grid__item" id="kt_subheader">
    <div class="kt-container ">
        <div class="kt-subheader__main">            
            ...
            <span class="kt-subheader__desc">Kategori Berita</span>            
        </div>
            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">  
                            <button type="button" class="btn btn-brand btn-icon-sm" data-toggle="modal" data-target="#modal_add" onclick="showModal()">
...
$this->load->view('datamaster/news/category/_add.php');
$this->load->view('datamaster/news/category/_script.php');
?>