...
// price.addEventListener('keyup', function(e){convertNumber(); hitung();});
    ...
    $(".btn_edit").on("click",function(){
        ...
        $.ajax({
            ...
            success : function(response,status){
                ...
                $('#modal_add').find('[name="price"]').val(convertToRupiah(response.data.price));
...
//     if(price){price=formatRupiah(price);}else{price=0;}
...
function submitHandler(event){
    ...
    if(id){
        ...
        // var price = event.target.querySelector('[name="price"]').value;
        // price.value = convertToRupiah(price.value);
        // console.log(price.value); ex     
    }
