...
function initDTEvents(){
    $(".btn_delete").on("click",function(){
        ...
        swal.fire({
            ...
            if (result.value) {
                ...
                $.ajax({
                    type : 'GET',
                    url : "<?php echo base_url("api/datamaster/payments/delete"); ?>",
                    data : {id:targetId},
                    dataType : "json",
    ...
    $(".btn_edit").on("click",function(){
        ...
        $.ajax({
            type : 'GET',
            url : "<?php echo base_url("api/datamaster/payments/get_byid"); ?>",
            data : {id:targetId},
            dataType : "json",
...
function initDataTable(){
    var option = {
        data: {
            ...
            source: {
              read: {
                url: '<?php echo base_url("api/datamaster/payments"); ?>',
                map: function(raw) {
                  // sample data mapping
                  var dataSet = raw;
...
function initCreateForm(){
    ...
    $("#btn_add_submit").on("click",function(){
      ...
      if(isValid){
        ...
        $.ajax({
            type : 'POST',
            url : "<?php echo base_url("api/datamaster/payments/insert"); ?>",
...
function initEditForm(){
    ...
    $("#btn_edit_submit").on("click",function(){
      ...
      if(isValid){
        ...
        $.ajax({
            type : 'POST',
            url : "<?php echo base_url("api/datamaster/payments/update"); ?>",
    ...
    var populateForm = function(groupObject){
        ...
        $("#edit_area_name").val(groupObject.jenis);
