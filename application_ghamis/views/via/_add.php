    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Input Transaksi Via</h5>
                        ...
                        <div class="row">    
                           ...
                           <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="id_payments" id="add_area">
                                    <?php 
                                        if (!empty($payments)){
                                ...
                                <div class="form-group">
                                    <label>Via</label>
                                    <input type="text" class="form-control" id="add_area" name="via">	                            		
                                </div>
                            </div>    
