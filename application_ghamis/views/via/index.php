...
<h3 class = 'kt-subheader__title'>Data Payments</h3>
<span class = 'kt-subheader__separator kt-subheader__separator--v'></span>
<span class = 'kt-subheader__desc'>Transaksi Via</span>
</div>
...
<?php if($this->session->userdata('user')->level == 'administrator' || $this->session->userdata('user')->level == 'unit' ):?>
...
$this->load->view( 'via/_add.php' );
$this->load->view( 'via/_edit.php' );
$this->load->view( 'via/_script.php' );
?>
