                        ...
                        <div class="row"> 
                            <div class="col-md-6">   
                                ...
                                <?php endif;?>                                    
                                    ...
                                    <div class="col-lg-2">
                                        <input type="text" class="form-control form-control-sm" id="e_noa_regular" name="e_noa_regular">
                                    </div>
                                    
                                    <label class="col-lg-4 col-form-label">Sisa UP Cicilan</label>
                                    <div class="col-lg-4">
                                        <input type="text" class="form-control form-control-sm" id="e_os_cicilan" name="e_os_cicilan" >
                                    </div>
                                    <label class="col-lg-2 col-form-label">NOA </label>
                                    <div class="col-lg-2">
                                        <input type="text" class="form-control form-control-sm" id="e_noa_cicilan" name="e_noa_cicilan">
                                    </div>
                                    ...
                                    <div class="col-lg-2">
                                        <input type="text" class="form-control form-control-sm" id="e_noa" name="e_noa" style="background-color:grey; color:white;" readonly>
                                    </div>
                                </div>
                            </div>  
