            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
                ...
                <div class="kt-portlet__head-toolbar">
				  <div class="kt-portlet__head-wrapper">
                    ...
                    <?php if($this->session->userdata('user')->level == 'administrator' || $this->session->userdata('user')->level == 'unit' || $this->session->userdata('user')->level == 'kasir'):?>
...
$this->load->view('transactions/bookcash/_viewpdf.php');
