...
<span class = 'kt-subheader__desc'>Data One Obligor</span>
</div>
...
<form id = 'form_bukukas' class = 'form-horizontal' method = 'post' action = '<?php echo base_url('report/oneobligor/export'); ?>'>
...
$this->load->view( 'oneobligor/js.php' );
