            ...
            <div class="kt-portlet kt-portlet--mobile">
                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    ...
                    <form id="form_bukukas" class="form-horizontal" method="post"
                        action="<?php echo base_url("dashboards/outstandingreport"); ?>">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-2">
                                        <input type="date" class="form-control" name="date"
                                            value="<?php  echo date('2022-12-31');?>">
                                    </div>
                                    <button type="button" class="btn btn-brand btn-icon" name="btncari" id="btncari"><i
                                            class="fa fa-search"></i></button> &nbsp
                        ...
                        <div class="kt-section__content">
                            <table class="table">
                                <thead class="thead-light"> 
                                    ...
                                    <td rowspan="2" align="center" width="100">Total <br />Outstanding <br />(<span
                                            class="today"></span>)</td>
                                    <td colspan="3" align="center" width="200">Disburse</td>
                                    </tr>
                                    <tr>
                                        <td align="center" width="40" bgcolor="#d6d6c2">Noa</td>
                                        <td align="center" width="90" bgcolor="#d6d6c2">Ost.Kemarin <br />(<span
                                                class="yesterday"></span>)</td>
                                        ...
                                        <td align="center" width="90" bgcolor="#b8b894">Ost. Regular<br />(<span
                                                class="today"></span>)</td>
                                        ...
                                        <td align="center" width="30" bgcolor="#b8b894">Noa</td>
                                        <td align="center" width="90" bgcolor="#b8b894">Ost. Cicilan<br />(<span
                                                class="today"></span>)</td>
...
$this->load->view('dashboard/outstanding/_script.php');
?>