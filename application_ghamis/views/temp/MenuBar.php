            ...
            <div id="kt_header_menu" class="kt-header-menu kt-header-menu-mobile ">
				...
				<?php if(read_access('transactions')):?>
                    ...
                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"
                        ...
                        <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                            <ul class="kt-menu__subnav">
                                ...
                                <li class="kt-menu__item " aria-haspopup="true">
                                    <a href="<?php echo base_url('penaksir/penaksir/mortages'); ?>"
                                        class="kt-menu__link ">
                                        <span class="kt-menu__link-icon"><i class="fa fa-file"><span></span></i></span>
                                        <span class="kt-menu__link-text">Gadai Cicilan</span>
                                    </a>
                    ...
                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"
                        ...
                        <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                            <ul class="kt-menu__subnav">
                                ...
                                <li class="kt-menu__item " aria-haspopup="true">
                                    <a href="<?php echo base_url('report/pelunasan/detailpelunasan'); ?>" class="kt-menu__link ">
                                        <span class="kt-menu__link-icon"><i class="fa fa-file"><span></span></i></span>
                                        <span class="kt-menu__link-text">Pelunasan</span>
                                    </a>
                                </li>
                                ...
                                <li class="kt-menu__item  kt-menu__item--submenu" data-ktmenu-submenu-toggle="hover"
                                    ...
                                    <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--right">
                                        <ul class="kt-menu__subnav">
                                            ...
                                            <li class="kt-menu__item " aria-haspopup="true">
                                                <a href="<?php echo base_url('report/penaksir/regular'); ?>"
                                                    class="kt-menu__link ">
                                                    <i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                                                    <span class="kt-menu__link-text">Gadai Regular</span>
                                            ...
                                            <li class="kt-menu__item " aria-haspopup="true">
                                                <a href="<?php echo base_url('report/penaksir/mortages'); ?>"
                                                    class="kt-menu__link ">
                                                    <i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                                                    <span class="kt-menu__link-text">Gadai Cicilan</span>
                                ...
                                <li class="kt-menu__item  kt-menu__item--submenu" data-ktmenu-submenu-toggle="hover"
                                    ...
                                    <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--right">
                                        <ul class="kt-menu__subnav">
                                            ...
                                            <li class="kt-menu__item " aria-haspopup="true">
                                                <a href="<?php echo base_url('report/lm/penjualan'); ?>"
                                                    class="kt-menu__link ">
                                                    <i
                                                        class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                                ...
                                <li class="kt-menu__item  kt-menu__item--submenu" data-ktmenu-submenu-toggle="hover"
                                    ...
                                    <a href="javascript:;" class="kt-menu__link kt-menu__toggle">
                                        ...
                                        <span class="kt-menu__link-text">YoGadai</span><i
                                            class="kt-menu__hor-arrow la la-angle-right"></i><i
                                            class="kt-menu__ver-arrow la la-angle-right"></i>
                                    </a>
                                    <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--right">
                    ...
                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"
                        ...
                        <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                            <ul class="kt-menu__subnav">
                                ...
                                <?php if(read_access('datamaster/payments')):?>
                                <li class="kt-menu__item " aria-haspopup="true">
                                    <a href="<?php echo base_url('datamaster/payments'); ?>" class="kt-menu__link ">
                                        <span class="kt-menu__link-icon"><i class="fa fa-file"><span></span></i></span>
                                ...
                                <?php if(read_access('datamaster/via')):?>
                                <li class="kt-menu__item " aria-haspopup="true">
                                    <a href="<?php echo base_url('datamaster/via'); ?>" class="kt-menu__link ">
                                        <span class="kt-menu__link-icon"><i class="fa fa-file"><span></span></i></span>
                                        <span class="kt-menu__link-text">Via</span>
                                    </a>
                                </li>
                                <?php endif;?>
                    ...
                    <li class="kt-menu__item  kt-menu__item--submenu" data-ktmenu-submenu-toggle="hover"
                        ...
                        <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--right">
                            <ul class="kt-menu__subnav">
                                ...
                                <?php if(read_access('report/konversi/outstanding')):?>
                                <li class="kt-menu__item " aria-haspopup="true">
                                    <a href="<?php echo base_url('report/selisih/outstanding'); ?>"
                                        class="kt-menu__link ">
                                        <i class="kt-menu__link-bullet kt-menu__link-bullet--dot"><span></span></i>
                                        <span class="kt-menu__link-text">Outstanding</span>
                                    </a>
                    ...
                    <li class="kt-menu__item  kt-menu__item--submenu kt-menu__item--rel"
                        data-ktmenu-submenu-toggle="click" aria-haspopup="true">
                        <a href="javascript:;" class="kt-menu__link kt-menu__toggle"><span
                                class="kt-menu__link-text">Cek Selisih </span><i
                                class="kt-menu__ver-arrow la la-angle-right"></i></a>
                        <div class="kt-menu__submenu kt-menu__submenu--classic kt-menu__submenu--left">
                            <ul class="kt-menu__subnav">
                                ...
                                <?php if(read_access('datamaster/payments')):?>
                                <li class="kt-menu__item " aria-haspopup="true">
                                    <a href="<?php echo base_url('datamaster/kasregular'); ?>" class="kt-menu__link ">
                                        <span class="kt-menu__link-icon"><i class="fa fa-file"><span></span></i></span>
                                        <span class="kt-menu__link-text">Buku Kas X Regular</span>
                                    </a>
                                </li>
                                <?php endif;?>
                                ...
                                <li class="kt-menu__item " aria-haspopup="true">
                                    <a href="<?php echo base_url('datamaster/via'); ?>" class="kt-menu__link ">
                                        <span class="kt-menu__link-icon"><i class="fa fa-file"><span></span></i></span>
                                        <span class="kt-menu__link-text">Buku Kas X Pelunasan</span>
                                    </a>
                                </li>
                                <?php endif;?>
