					...
					<!-- tambah -->
					<?php if(read_access('datamaster')):?>
						<li class="kt-menu__item kt-menu__item--submenu kt-menu__item--rel" data-ktmenu-submenu-toggle="click" aria-hashpopup="true">
							<a href="javascript:;" class="kt-menu__link kt-menu_toggle"><span class="kt-menu___link-text">Data Master</span><i class="kt-menu__ver-arrow la la-angle-right"></i></a>
							<div class="kt-menu__submenu kt-menu__submenu--classic kt-menu_submenu--left">
								<ul class="kt-menu__subnav">

								<?php if(read_access('datamaster/customers')):?>
									<li class="kt-menu__item" aria-hashpopup="true">
										<a href="<?php echo base_url('datamaster/customers');?>" class="kt-menu__link">
										<span class="kt-menu__link-icon"><i class="fa fa-file"><span></span></i></span>
