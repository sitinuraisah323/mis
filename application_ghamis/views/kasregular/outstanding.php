...
<h3 class = 'kt-subheader__title'>Selisih</h3>
<span class = 'kt-subheader__separator kt-subheader__separator--v'></span>
<span class = 'kt-subheader__desc'>Kas X Regular</span>
</div>
...
<th class = 'text-right'>NOA ( Kas )</th>
<th class = 'text-right'>UP ( Kas )</th>
<th class = 'text-right'>NOA ( Reg )</th>
<th class = 'text-right'>UP ( Reg )</th>
<th class = 'text-right'>Selisih ( NOA )</th>
<th class = 'text-right'>Selisih ( UP )</th>
<th></th>
</tr>
</thead>
</table>
...
$this->load->view( 'kasregular/_outstanding.php' );
?>
