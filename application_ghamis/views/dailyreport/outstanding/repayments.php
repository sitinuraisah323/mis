...
<table class="table" border="1">
	...
	<tr  bgcolor="#cccccc">
		...
		<th width="340" colspan="4" align="center">Total Pelunasan Akumulasi  (<?php echo date('d F Y', strtotime($datetrans)); ?>)</th>
		<th width="340"colspan="4" align="center" >Total Pelunasan Today  (<?php echo date('d F Y', strtotime($datetrans)); ?>)</th>
		<th width="140"colspan="3" align="center" >Pelunasan(<?php echo date('Y', strtotime($datetrans)); ?>)</th>
	...
	foreach($repayments as $data): $no++;?>
		<tr>
			...
			<td width="100" align="right"> <?php echo money($data->disburse_up);?></td>
		</tr>
		<?php
	...
	<td width="100" align="right"><?php echo money($disburse_up);?></td>
    </tr>
	</tbody>
	<tfoot>
	</tfoot>
