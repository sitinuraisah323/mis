                    ...
                    <div class="row">                    
                        <div class="col-md-6"> 
                            <div class="form-group row"> 
                                ...
                                <label class="col-lg-2 col-form-label">NOA Regular</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control form-control-sm" id="noa_regular" name="noa_regular" readonly>
                                </div>
                                <label class="col-lg-2 col-form-label">NOA Cicilan</label>
                                <div class="col-lg-10">
                                    <input type="text" class="form-control form-control-sm" id="noa_cicilan" name="noa_cicilan" readonly>
                                </div>
