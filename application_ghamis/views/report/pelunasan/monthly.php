...
<!-- end:: Content Head -->
 ...
 <div class="kt-container  kt-container--fluid  kt-grid__item kt-grid__item--fluid">
        ...
        <div class="kt-portlet__body kt-portlet__body--fit">
            ...
            <form id="form_bukukas" class="form-horizontal" method="post" action="<?php echo base_url("report/pelunasan/export_monthly"); ?>">
						...
						<table class="table">
						  	<thead class="thead-light">
                                ...
                                <th class="text-center">No</th>
									...
									<th class='text-right'>Pelunasan Regular</th>
									<th class='text-right'>Pelunasan Cicilan</th>
...
$this->load->view('report/pelunasan/_view.php');
